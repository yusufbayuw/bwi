        <div class="md:hidden w-full fixed inset-x-0 bottom-0 h-16 bg-primary-600 mt-8 border-t border-gray-200 z-50">
            <div class="grid h-full w-full grid-flow-col mx-auto font-medium">
                <a href="{{ $dasborUrl }}"
                    class="inline-flex flex-col items-center justify-center px-5 text-white transition duration-75 hover:text-gray-50 group">
