...
<html>
    ...
    <body>
        ...
        <p>
            ...
            related to it, still belong to yubawi.
        </p>
        <p>
            yubawi is committed to ensuring that the app is as useful and
        ...
        <p>
            The bwi app stores and processes personal data that you have
            ...
            phone's security features and it could mean that the bwi app won't
        ...
        <p>
            You should be aware that there are certain things that yubawi will
            ...
            but yubawi cannot take responsibility for the app not working at
        ...
        <p>
            Along the same lines, yubawi cannot always take responsibility for
            ...
            to avail the Service, yubawi cannot accept responsibility.
        </p>
        <p>
            With respect to yubawi's responsibility for your use of the app,
            ...
            that we can make it available to you. yubawi accepts no liability
        ...
        <p>
            ...
            to keep using the app. yubawi does not promise that it will always
        ...
        <p>These terms and conditions are effective as of 2023-12-20</p>
        <p><strong>Contact Us</strong></p>
        <p>
            If you have any questions or suggestions about my Terms and
            Conditions, do not hesitate to contact me at dev@yubawi.com.
        </p>
    </body>
</html>
